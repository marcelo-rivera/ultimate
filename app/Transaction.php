...
class Transaction extends Model
{
    ...
    public function lastNFe(){
        ...
        if(!$transation) return $config->ultimo_numero_nfe;
        if($transation->numero_nfe > $config->ultimo_numero_nfe) return $transation->numero_nfe;
        else return $config->ultimo_numero_nfe;
    }
