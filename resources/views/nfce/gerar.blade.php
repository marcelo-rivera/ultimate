...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-5">
        <h4>Ultimo numero NFC-e: <strong>{{$transaction->lastNFCe()}}</strong></h4>
      ...
      <div class="col-md-12">
        <a class="btn btn-lg btn-primary" target="_blank" href="/nfce/renderizar/{{$transaction->id}}" id="submit_user_button">Renderizar</a>
