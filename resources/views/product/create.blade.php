    ...
    <div class="row">
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          <input required value="0.00" class="form-control" placeholder="%ICMS" data-mask="00.00" name="perc_icms" type="text" id="perc_icms">
        </div>
      </div>
      <div class="col-sm-2">
        <div class="form-group">
          <label for="product_custom_field2">%PIS:</label>
          <input required value="0.00" class="form-control" placeholder="%PIS" data-mask="00.00" name="perc_pis" type="text" id="perc_pis">
        </div>
      </div>
      <div class="col-sm-2">
        <div class="form-group">
          <label for="product_custom_field2">%COFINS:</label>
          <input required value="0.00" class="form-control" placeholder="%COFINS" data-mask="00.00" name="perc_cofins" type="text" id="perc_cofins">
        </div>
      </div>
      <div class="col-sm-2">
        <div class="form-group">
          <label for="product_custom_field2">%IPI:</label>
          <input required value="0.00" class="form-control" placeholder="%IPI" data-mask="00.00" name="perc_ipi" type="text" id="perc_ipi">
        </div>
      </div>
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          <input required value="" required class="form-control" data-mask="0000" placeholder="CFOP Estadual" name="cfop_interno" type="number" id="cfop_interno">
        </div>
      </div>
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          <input required value="" required class="form-control" data-mask="0000" placeholder="CFOP Inter estadual" name="cfop_externo" type="number" id="cfop_externo">
        </div>
      </div>
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          <input required value="" required class="form-control" data-mask="0000.00.00" placeholder="NCM" name="ncm" type="text" id="ncm">
        </div>
      </div>
