...
<section class="content no-print">
	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="form-group">
				{!! Form::label('sell_note', 'Informação complementar') !!}
		...
		<div class="col-md-2 col-sm-2">
			<div class="form-group">
				...
				{!! Form::select('tipo', $tiposFrete, 'tipo' , ['class' => 'form-control select2', 'data-default' => 'percentage']); !!}
		...
		<div class="col-md-2">
			<div class="form-group">
				...
				{!! Form::text('peso_liquido', null, ['class' => 'form-control','placeholder' => 'Peso liquido']); !!}
			</div>
		</div>
		...
		<div class="col-md-2">
			<div class="form-group">
				...
				{!! Form::text('peso_bruto', null, ['class' => 'form-control','placeholder' => 'Peso bruto']); !!}
			</div>
		</div>
		...
		<div class="col-md-2">
			<div class="form-group">
				...
				{!! Form::text('valor_frete', null, ['class' => 'form-control','placeholder' => 'Valor do frete']); !!}
			</div>
		</div>
		...
		<div class="col-sm-4">
			<div class="form-group">
				...
				{!! Form::select('transportadora_id', $transportadoras, 'transportadora_id' , ['class' => 'form-control select2','placeholder' => 'Transportadora', 'data-default' => 'percentage']); !!}
